<!-- buku untuk admin memencet tombol pinjam -->
<div class="row mx-4">
                    ...
                    <div class="card-body" style="padding:10px">
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title text-center" style="line-height: 0.5;">{{ $item->judul_buku }}</h5>
                                ...
                                <div class="card-body" style="padding:5px">
                                    ...
                                    @elseif($item->stok_buku != 0)
                                        <a href="{{route('showr',$item->id)}}" class="btn btn-primary">Pinjam</a>
                                    @endif
                                </div> 
                            </div>
                        </div>
